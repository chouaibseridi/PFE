...
mysql_query("INSERT INTO `reservation_hotel` (`id_hotel`, `email_client`, `date_res`) VALUES ('$id', '$oem', '$date')");


$reponse=mysql_query("SELECT prix FROM `hotel` WHERE id='$id'");
...
<br><br>
<div id="link">
<a href="hotel offers.php"> Go back </a> <tr>
<a> | </a>
