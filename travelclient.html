...
<div id="ban"> 
  ...
  <div id="logo" > <a href=#> <img  src="images/logo.jpg" onmouseover="this.src='images/logo2.jpg'"; onmouseout="this.src='images/logo.jpg'"> </a></div>
    ...
    <div id="menu">
    <div class="dropdown">
    <button class="dropbtn" onclick="window.location.href='travelclient.php'">Home</button>
    </div>
    <div class="dropdown">
    <button class="dropbtn">Booking</button>
    <div class="dropdown-content">
    <a href="trip offers.php">Trip offers</a>
    <a href="hotel offers.php">Hotels</a>
    </div>
    </div>
    <div class="dropdown">
    ...
    <button class="dropbtn2">My Account</button>
	  <div class="dropdown-content">
    <a href="clientmanager.php">Settings</a>
...
<div id="engine_bar"> 
  ...
  <div id="rech">  <label> Destination </label> <br> <input type="text" placeholder="Where do you like to go ?" id="rech1"/ name="search"> </div>
  <div id="book">  <button name ="find" value="find" id="rech4"> </button> </div>
  </form>
 </div>
