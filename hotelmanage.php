...
<body>
 ...
 <div id="contenaire">
       <p id="titre2"> Hotel manager ! </p>
<button class="accordion">Add Hotel</button>
<div class="panel"><br>
<form method="post" action="h_add.php">
Pays <br><input type="text" name="pays"/><br>
Ville <br> <input type="text" name="ville"/><br>
Nom <br> <input type="text" name="nom"/><br>
Nombre de lits<br><input type="text" name="lit"/><br>
...
<button class="accordion">Edit Hotel</button>
<div class="panel"><br>
<p> Hotel List </p><br>
<?php
{
...
<th>Nom: <?php echo $donne['nom'];?> </th>
<th>Nombre de lits: <?php echo $donne['lit'];?> </th>
...
?>
<br>
<form method="post" action="h_edit.php">
...
<button class="accordion">Delete Hotel</button>
<div class="panel"><br>
<p> Hotel List </p><br>
<?php
{
...
?>
<br>
<form method="post" action="h_del.php">
